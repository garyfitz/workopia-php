...
class ListingController 
{
  ...
  */
  public function store() 
  {
    ...
    if(!empty($errors)) {
      ...
      // Set flash message
      Session::setFlashMessage('success_message', 'Listing added sucessfully');
  ...
  */
  public function destroy($params) {
    ...
    // Set flash message
    Session::setFlashMessage('success_message', 'Listing deleted sucessfully');
    redirect('/listings');
  }
  ...
  */
  public function update($params)
  {
    ...
    if(!empty($errors)) {
      ...
      // Set flash message
      Session::setFlashMessage('success_message', 'Listing updated sucessfully');
